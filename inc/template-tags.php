	...
	function understrap_posted_on() {
		...
		$byline      = apply_filters(
			'understrap_posted_by', sprintf(
				...
				$posted_on ? esc_html_x( 'Por', 'post author', 'understrap' ) : esc_html_x( 'Por', 'post author', 'understrap' ),
				esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
				esc_html( get_the_author_meta('first_name').' '.get_the_author_meta('last_name') )
			)
		);
	...
	function understrap_entry_footer() {
		...
		if ( is_single() ) {
			echo '<div class="box-author">';
				echo '<div class="box-author-image">'. get_avatar( get_the_author_meta( 'ID' )).'</div>';
				echo '<div class="box-author-text">';
					echo '<div>'.esc_html( get_the_author_meta('first_name').' '.get_the_author_meta('last_name') ).'</div>';
					echo '<div>'.esc_html( get_the_author_meta('description') ).'</div>';
					echo '<div><a href="https://twitter.com/'.esc_html( get_the_author_meta('twitter') ).'" target="_new"><i class="fa fa-twitter" aria-hidden="true"></i></a></div>';
				echo '</div>';
			echo '</div>';
		}
	}
