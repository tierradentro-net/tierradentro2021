...
require_once( trailingslashit( get_template_directory() ) . '/inc/widgets/services.php' );
require_once( trailingslashit( get_template_directory() ) . '/inc/widgets/team.php' );
...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Blog Top Widget Slider', 'understrap' ),
				'id'            => 'hero',
		...
		register_sidebar(
			array(
				'name'          => __( 'Blog Top Widget Canvas', 'understrap' ),
				'id'            => 'herocanvas',
		...
		register_sidebar(
			array(
				'name'          => __( 'Blog Top Widget Full', 'understrap' ),
				'id'            => 'statichero',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Widgets', 'understrap' ),
				'id'            => 'footerfull',
		...
		register_sidebar( array(
			'name'		  => __( 'Services Widgets', 'tierradentro2021' ),
			'id'			=> 'services-widgets',
			'before_widget' => '',
			'after_widget'  => '',
			'before_title'  => '',
		...
		/*register_sidebar( array(
			'name'		  => __( 'Portfolio Widgets', 'tierradentro2021' ),
			'id'			=> 'portfolio-widgets',
			'before_widget' => '<div data-sr="enter bottom wait 0.25s" class="portfolio-item col-md-4 col-sm-6"><div class="portfolio-item-container">',
			'after_widget'  => '</div></div>',
			'before_title'  => '<div class="overlay"><div class="text"><h4>',
			'after_title'   => '</h4></div></div>',
		) );*/

		register_sidebar( array(
			'name'		  => __( 'Team Widgets', 'tierradentro2021' ),
			'id'			=> 'team-widgets',
			'before_widget' => '',
			'after_widget'  => '',
			'before_title'  => '',
